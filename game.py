...
def parse(state: dict):
    ...
    bank = Bank(players, island, state['card list copy'], state['secret'], cache)
...
if __name__ == "__main__":
    with open("/Users/oleg/PycharmProjects/container_v2/1.json", 'w') as f:
